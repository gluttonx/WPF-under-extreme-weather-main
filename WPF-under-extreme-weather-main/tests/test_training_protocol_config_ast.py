...
class TrainingProtocolConfigAstTest(unittest.TestCase):
    ...
    def test_training_declares_high_wind_aware_loss_controls(self):
        ...
        for token in [
            ...
            "def get_target_aware_selective_fed_local_ft_model_path",
            "target_aware_selective_fed_local_ft_station",
            "Target-Aware Selective Fed-Meta + Local FT",
            ...
            "def resolve_target_aware_selective_fed_base_model_path",
