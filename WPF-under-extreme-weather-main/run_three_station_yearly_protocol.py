...
PREVIEW_ENV_KEYS = [
    ...
    "LOCAL_PRETRAIN_EPOCH_OFFSET",
    "LOCAL_META_EPOCH_OFFSET",
    "TARGET_AWARE_PRETRAIN_EPOCH_OFFSET",
    "TARGET_AWARE_META_EPOCH_OFFSET",
    ...
    "ENABLE_LEGACY_LOCAL_FT",
    "ENABLE_TARGET_AWARE_META_BIAS_CAL",
...
def build_env(
    ...
    target_aware_selective_fed_base_model_output_dir = env.get(
        "TARGET_AWARE_SELECTIVE_FED_BASE_MODEL_OUTPUT_DIR",
        target_aware_base_model_output_dir,
    )
    ...
    env.update({
        ...
        "LOCAL_PRETRAIN_INIT_MODEL_DIR": env.get("LOCAL_PRETRAIN_INIT_MODEL_DIR", ""),
        "LOCAL_META_INIT_MODEL_DIR": env.get("LOCAL_META_INIT_MODEL_DIR", ""),
        "TARGET_AWARE_PRETRAIN_INIT_MODEL_DIR": env.get("TARGET_AWARE_PRETRAIN_INIT_MODEL_DIR", ""),
        "TARGET_AWARE_META_INIT_MODEL_DIR": env.get("TARGET_AWARE_META_INIT_MODEL_DIR", ""),
        "TARGET_AWARE_SELECTIVE_FED_META_INIT_MODEL_DIR": env.get("TARGET_AWARE_SELECTIVE_FED_META_INIT_MODEL_DIR", ""),
        "LOCAL_PRETRAIN_EPOCH_OFFSET": env.get("LOCAL_PRETRAIN_EPOCH_OFFSET", "0"),
        "LOCAL_META_EPOCH_OFFSET": env.get("LOCAL_META_EPOCH_OFFSET", "0"),
        "TARGET_AWARE_PRETRAIN_EPOCH_OFFSET": env.get("TARGET_AWARE_PRETRAIN_EPOCH_OFFSET", "0"),
        "TARGET_AWARE_META_EPOCH_OFFSET": env.get("TARGET_AWARE_META_EPOCH_OFFSET", "0"),
        ...
        "RUN_FEDERATED_PRETRAIN": env.get("RUN_FEDERATED_PRETRAIN", RUN_FEDERATED_PRETRAIN),
        "FED_PRETRAIN_ALGO": env.get("FED_PRETRAIN_ALGO", "fedavg" if env.get("RUN_FEDERATED_PRETRAIN", RUN_FEDERATED_PRETRAIN) != "0" else "fedsgd"),
        "FEDAVG_LOCAL_EPOCHS": env.get("FEDAVG_LOCAL_EPOCHS", "1"),
        "FEDAVG_CLIENT_WEIGHTING": env.get("FEDAVG_CLIENT_WEIGHTING", "uniform"),
        "FEDAVG_LR": env.get("FEDAVG_LR", "0.0002"),
        ...
        "ENABLE_FEDTL_FT": env.get("ENABLE_FEDTL_FT", "0"),
        ...
        "ENABLE_LEGACY_LOCAL_FT": env.get("ENABLE_LEGACY_LOCAL_FT", "0"),
        "ENABLE_TARGET_AWARE_META_BIAS_CAL": env.get("ENABLE_TARGET_AWARE_META_BIAS_CAL", "0"),
        ...
        "TARGET_AWARE_SELECTIVE_FED_BIAS_CAL_MIN": env.get("TARGET_AWARE_SELECTIVE_FED_BIAS_CAL_MIN", "0.0"),
        "TARGET_AWARE_SELECTIVE_FED_BIAS_CAL_MAX": env.get("TARGET_AWARE_SELECTIVE_FED_BIAS_CAL_MAX", "0.15"),
        "GLOBAL_SEED": env.get("GLOBAL_SEED", "1029"),
        "FEW_SHOT_LR": env.get("FEW_SHOT_LR", "0.0002"),
        "ENABLE_FT_SWEEP": env.get("ENABLE_FT_SWEEP", "0"),
        "FT_SWEEP_EPOCHS": env.get("FT_SWEEP_EPOCHS", ""),
        "FT_SWEEP_OUTPUT_PATH": env.get("FT_SWEEP_OUTPUT_PATH", ""),
        "FT_SWEEP_SAVE_CHECKPOINTS": env.get("FT_SWEEP_SAVE_CHECKPOINTS", "1"),
        "FT_SWEEP_EVAL_TEST": env.get("FT_SWEEP_EVAL_TEST", "1"),
    ...
    if high_wind_spring_noft:
        ...
        if (
            env.get("ENABLE_TARGET_AWARE_SELECTIVE_FED_LOCAL_FT", "0") != "0"
            or env.get("ENABLE_LEGACY_LOCAL_FT", "0") != "0"
            or env.get("ENABLE_FEDTL_FT", "0") != "0"
        ):
            if (
                env.get("ENABLE_FEDTL_FT", "0") != "0"
                and env.get("ENABLE_LEGACY_LOCAL_FT", "0") == "0"
                and "SKIP_LEGACY_EXTREME_ADAPTATION" not in os.environ
            ):
                env["SKIP_LEGACY_EXTREME_ADAPTATION"] = "1"
            env.update({
                "FEW_SHOT_EPOCHS": os.environ.get("FEW_SHOT_EPOCHS", "5"),
                "FEW_SHOT_LR": os.environ.get("FEW_SHOT_LR", "5e-5"),
                "EXTREME_TARGET_REFINEMENT_EPOCHS": os.environ.get("EXTREME_TARGET_REFINEMENT_EPOCHS", "5"),
                "EXTREME_TARGET_ADAPT_MAX_WINDOWS": os.environ.get("EXTREME_TARGET_ADAPT_MAX_WINDOWS", "0"),
    ...
    for key in RUNTIME_ENV_OVERRIDE_KEYS:
